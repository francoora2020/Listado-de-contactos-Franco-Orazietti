<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormularioCarga.aspx.cs" Inherits="Listado_de_contactos.FormularioCarga" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <br />
            Nombre <asp:TextBox ID="TextBox1" runat="server" required="true"></asp:TextBox>
            <br />
            <br />
            Apellido
